...
import br.com.markConsult.classesMetodos.CondPagtTableModel;
 ...
 * @author jeferson
 */
public class BuscaCondPagt extends javax.swing.JDialog {

    private boolean okselecionado = false;
    List<CondPagto> condPagtos;
    private final CondPagtTableModel model;
     ...
     * @param modal
     */
    public BuscaCondPagt(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        URL url = this.getClass().getResource("/br/com/markConsult/imagens/help.png");  
        Image imagemTitulo = Toolkit.getDefaultToolkit().getImage(url);  
        this.setIconImage(imagemTitulo); 
        model = new CondPagtTableModel();
        jTCondPagto.setModel(model);

        CadCondPagtoDAO dao = new CadCondPagtoDAO();
        List<CondPagto> usu = dao.BuscaCondPagto("", 'e');
        model.listar(usu);

        tf_dado.setDocument(new FixedLengthDocument(70));
        jTCondPagto.getColumnModel().getColumn(0).setMinWidth(15);
        jTCondPagto.getColumnModel().getColumn(1).setPreferredWidth(200);
        jTCondPagto.getSelectionModel().setSelectionInterval(0, 0);
        
         TableRowSorter<CondPagtTableModel> sorter = new TableRowSorter<>((CondPagtTableModel) jTCondPagto.getModel());  
            jTCondPagto.setRowSorter(sorter);
        
        
        JTableHeader header = jTCondPagto.getTableHeader();  
    ...
    private void initComponents() {
        ...
        jTCondPagto = new javax.swing.JTable();
        ...
        setTitle("Busca Condição de Pagamento");
        setResizable(false);
        ...
        jTCondPagto.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        jTCondPagto.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTCondPagtoMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTCondPagto);

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Busca Condição de Pagamento", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP));
        ...
        cb_campo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Convênio", "Código" }));
    ...
    private void jTCondPagtoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTCondPagtoMouseClicked
    ...
    }//GEN-LAST:event_jTCondPagtoMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaCondPagt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                BuscaCondPagt dialog = new BuscaCondPagt(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable jTCondPagto;
    private javax.swing.JTextField tf_dado;
    // End of variables declaration//GEN-END:variables

 

    public CondPagto retornEspSele() {
        int sele = jTCondPagto.getSelectedRow();
          System.out.println(sele);
        CondPagto c = null;
        if (sele >= 0) {
            sele = jTCondPagto.convertRowIndexToModel(sele);
            System.out.println(sele);
    ...
    public void pesquisa() {
     CadCondPagtoDAO dao = new CadCondPagtoDAO();
        ...
        switch (cb_campo.getSelectedIndex()) {
            case 0:
                condPagtos = dao.BuscaCondPagto(valor, 'e');
                break;
            case 1:
                condPagtos = dao.BuscaCondPagto(valor, 'i');
                break;


        }

        model.listar(condPagtos);
