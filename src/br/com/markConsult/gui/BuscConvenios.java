...
import br.com.markConsult.classesMetodos.ConveniosTableModel;
 ...
 * @author jeferson
 */
public class BuscConvenios extends javax.swing.JDialog {

    private boolean okselecionado = false;
    List<Convenio> convenios;
    private ConveniosTableModel model;
     ...
     * @param modal
     */
    public BuscConvenios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        URL url = this.getClass().getResource("/br/com/markConsult/imagens/help.png");  
        Image imagemTitulo = Toolkit.getDefaultToolkit().getImage(url);  
        this.setIconImage(imagemTitulo); 
        model = new ConveniosTableModel();
        jTConvenios.setModel(model);

        CadConvenioDAO dao = new CadConvenioDAO();
        List<Convenio> usu = dao.BuscaConvenios("", 'e');
        model.listar(usu);

        tf_dado.setDocument(new FixedLengthDocument(70));
        jTConvenios.getColumnModel().getColumn(0).setMinWidth(15);
        jTConvenios.getColumnModel().getColumn(1).setPreferredWidth(200);
        jTConvenios.getSelectionModel().setSelectionInterval(0, 0);
        
        
         jTConvenios.setAutoCreateRowSorter(true);
        
        TableRowSorter<ConveniosTableModel> sorter = new TableRowSorter<>((ConveniosTableModel) jTConvenios.getModel());  
            jTConvenios.setRowSorter(sorter);
        
        
        JTableHeader header = jTConvenios.getTableHeader();  
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Busca Convênios", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscConvenios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                BuscConvenios dialog = new BuscConvenios(new javax.swing.JFrame(), true);
    ...
    public Convenio retornEspSele() {
        int sele = jTConvenios.getSelectedRow();
        Convenio c = null;
        if (sele >= 0) {
            sele = jTConvenios.convertRowIndexToModel(sele);
    ...
    public void pesquisa() {
        ...
        switch (cb_campo.getSelectedIndex()) {
            case 0:
                convenios = dao.BuscaConvenios(valor, 'e');
                break;
            case 1:
                convenios = dao.BuscaConvenios(valor, 'i');
                break;


        }

        model.listar(convenios);
