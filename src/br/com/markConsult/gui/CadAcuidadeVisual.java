                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(tf_idPaciente, javax.swing.GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE)
                                    .addComponent(tf_idEMpresa)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(tf_funcaoPaciente))))
                .addContainerGap())
        );
    ...
    private void bt_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_salvarActionPerformed
        ...
        if (verificaCampos()) {
            try {
                ...
                String id_empresa = tf_idEMpresa.getText();
                if (!id_empresa.equals("")) {
                    empresa.setId(Integer.parseInt(id_empresa));
                }
                Convenio convenio = new Convenio();
                String id_convenio = tf_idconve.getText();
                if (!id_convenio.equals("")) {
                    convenio.setId(Integer.parseInt(id_convenio));
                }
                ...
                if (inserir_alterar == 0) {
                    ...
                    AcuidadeVisual av = new AcuidadeVisual(null,paciente,exameSelecionado, olhoDireitoSemCorrecaoInt, 
                            ...
                            jc_vermelho.isSelected(), jc_amarelo.isSelected(), jc_verde.isSelected(), conclusaoSelecionado, observacao,dataConve,empresa,null);
                ...
                if (inserir_alterar == 1) {
                    ...
                    AcuidadeVisual av = new AcuidadeVisual(codigo,paciente, exameSelecionado, 
                            ...
                            olhoEsquerdoComCorrecaoInt, jc_vermelho.isSelected(), jc_amarelo.isSelected(), jc_verde.isSelected(), conclusaoSelecionado, observacao,dataConve,empresa,null);
                    dao.alterar(av);
...
public final java.util.Date converte(String dataConsul) throws ParseException {
    ...
    private void mostrar_dados(AcuidadeVisual a) {
        ...
        tf_idEMpresa.setText(a.getEmpresa().getId().toString());
        tf_nomeEmpresa.setText(a.getEmpresa().getFantasia());
