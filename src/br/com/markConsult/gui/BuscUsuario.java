 ...
 * @author jeferson
 */
public class BuscUsuario extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public BuscUsuario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        List<Usuario> usu = dao.BuscaUsuarios("", 'e');
        model.listar(usu);

        tf_dado.setDocument(new FixedLengthDocument(70));
        jTUsuarios.getColumnModel().getColumn(0).setMinWidth(15);
        jTUsuarios.getColumnModel().getColumn(1).setPreferredWidth(200);
        jTUsuarios.getSelectionModel().setSelectionInterval(0, 0);
        
        
        TableRowSorter<UsuarioTableModel> sorter = new TableRowSorter<>((UsuarioTableModel) jTUsuarios.getModel());  
            jTUsuarios.setRowSorter(sorter);
        
        
        JTableHeader header = jTUsuarios.getTableHeader();  
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Busca Usuários", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP));
        ...
        cb_campo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Login", "Código" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                BuscUsuario dialog = new BuscUsuario(new javax.swing.JFrame(), true);
    ...
    public Usuario  retornEspSele() {
      int sele = jTUsuarios.getSelectedRow();
        Usuario m  = null;
        if (sele >= 0) {
             sele = jTUsuarios.convertRowIndexToModel(sele);
    ...
    public void pesquisa() {
        ...
        switch (cb_campo.getSelectedIndex()) {
            case 0:
                usuarios = dao.BuscaUsuarios(valor, 'e');
                break;
            case 1:
                usuarios = dao.BuscaUsuarios(valor, 't');
                break;

        }
        model.listar(usuarios);
