 ...
 * @author jeferson
 */
public class CadCondPagto extends javax.swing.JInternalFrame {
int inserir_alterar = 0;
    /**
     * Creates new form CadCondPagto
     */
    public CadCondPagto() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Condição de Pagamento", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP));
    ...
    private void bt_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_salvarActionPerformed
        if (inserir_alterar == 0) {
            ...
            CondPagto condPagto = new CondPagto(null, descricao);

            int id = dao.inserir(condPagto);
    ...
    private void bt_excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_excluirActionPerformed
        ...
        if (opcao_escolhida == JOptionPane.YES_OPTION) {
            ...
            if (excludo) {
                ...
                JOptionPane.showMessageDialog(null, "Condição de pagamento não pode ser excluído porque está sendo utilizado em outra tabela!");
            }
        }
...
if ("inicial".equals(botao)) {
 ...
 public void mostrar_dados(CondPagto condPagto) {
if(condPagto!=null){
        tf_codigo.setText("" + condPagto.getId());
        tf_descri.setText(condPagto.getCondPagt());
...
public void buscaPorId(String id) {
     if (!tf_codigo.getText().equals("")) {
       ICadCondPagtoDAO dao = new CadCondPagtoDAO();
        CondPagto condPagto = dao.procuraPorID(Integer.parseInt(id));
        if(condPagto==null){
