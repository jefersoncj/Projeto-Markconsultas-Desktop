...
public class CadEmpresa extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro de Empresas", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP));
    ...
    private void bt_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_salvarActionPerformed
        ...
        logoEmpresa = new LogoEmpresa(nome, null);

        if (inserir_alterar == 0) {

            CadEmpresaDAO dao = new CadEmpresaDAO();
            Empresa empresa = new Empresa(null, fantasia, razao, email, numero, cnpj, fonefixo, celular1, celular2, cep, logoEmpresa);
        ...
        if (inserir_alterar == 1) {
            ...
            CadEmpresaDAO dao = new CadEmpresaDAO();
            Empresa empresa = new Empresa(codigo, fantasia, razao, email, numero, cnpj, fonefixo, celular1, celular2, cep, logoEmpresa);
            dao.altEmpresa(empresa);
        }
        inserir_alterar = 0;
    ...
    public void mostrar_dados(Empresa emp) {
        ...
        if (emp != null) {
            ...
            try {
                ...
                tf_imagem.setText(emp.getLogoEmpresa().getNome());

                byte[] imagemStream = emp.getLogoEmpresa().getFigura();
