 ...
 * @author jeferson
 */
public class BuscEspecialidades extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public BuscEspecialidades(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscEspecialidades.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                BuscEspecialidades dialog = new BuscEspecialidades(new javax.swing.JFrame(), true);
