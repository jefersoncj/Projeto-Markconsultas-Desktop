...
public class Paciente {
    ...
    public Paciente(Integer id, String numConvenio, String nome) {
        this.id = id;
    ...
    public Paciente(Integer id, String numConvenio, Convenio convenio, String nome, String email, String numero, String complemento, String cpf, String rg, Date dataNasc, String tipoSangue, String foneFixo, String celular1, String celular2, String celular3, String obs, Cep cep, boolean desabilitado, String nomeMae, String nomePai) {
        this.id = id;
        this.numConvenio = numConvenio;
    ...
    public Paciente(Integer id, String numConvenio, Convenio convenio, String nome, String email, String numero, String complemento, String cpf, String rg, Date dataNasc, String tipoSangue, String foneFixo, String celular1, String celular2, String celular3, String obs, Cep cep, boolean desabilitado, Date dataUltConsu, Integer status, String nomeMae) {
        this.id = id;
        this.numConvenio = numConvenio;
        this.convenio = convenio;
        this.nome = nome;
