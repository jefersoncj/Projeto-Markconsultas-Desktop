...
public class Consulta {
    ...
    public Consulta(Integer id, Convenio convenio, Paciente paciente, Usuario usuario, Date dataConsulta, Integer status, Integer sequencia, String obs, double valor, CondPagto condPagt, Tipo tipo, Procedimento procedimento, boolean fila, boolean prioritario, String codAutorizacao) {
        this.id = id;
        this.convenio = convenio;
        this.paciente = paciente;
        this.usuario = usuario;
    ...
    public Consulta(Integer id, Convenio convenio, Paciente paciente, Usuario usuario, Date dataConsulta, Integer status, Integer sequencia, String obs, double valor, CondPagto condPagt, Tipo tipo, Procedimento procedimento) {
        this.id = id;
        this.convenio = convenio;
        this.paciente = paciente;
        this.usuario = usuario;
