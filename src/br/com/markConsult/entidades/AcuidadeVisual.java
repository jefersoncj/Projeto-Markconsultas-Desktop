...
public class AcuidadeVisual {
    ...
    public AcuidadeVisual(Integer id, Paciente paciente, String tipoExame, Integer olhoDireitoSemCorrecao, Integer olhoEsquerdoSemCorrecao, Integer olhoDireitoComCorrecao, Integer olhoEsquerdoComCorrecao, boolean vermelho, boolean amarelo, boolean verde, String conclusao, String observacao, Date data, Empresa empresa, Funcao funcao) {
        this.id = id;
